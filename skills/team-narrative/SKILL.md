name: team-narrative
description: Coordinate writer, world-builder, and narrative-director on story content.
allowed-tools: read_file, write_file, delegate_task, clarify, search_files
model: sonnet
agent: narrative-director

Team Narrative — Multi-Agent Feature Coordination

Coordinates multiple specialists via delegate_task(tasks=[...]) to implement a narrative feature end-to-end.
...
Read all relevant GDDs for the narrative systems.
...
- writer: writes dialogue and descriptions
- world-builder: ensures lore consistency
- narrative-director: reviews for tone and arc coherence
...
Present:
```
## Team Narrative — Integration Report
