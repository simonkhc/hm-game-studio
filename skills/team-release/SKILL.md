name: team-release
description: Coordinate devops-engineer, qa-tester, and release-manager on release pipeline.
allowed-tools: read_file, write_file, delegate_task, clarify, search_files
model: sonnet
agent: release-manager

Team Release — Multi-Agent Feature Coordination

Coordinates multiple specialists via delegate_task(tasks=[...]) to implement a release feature end-to-end.
...
Read all relevant GDDs for the release systems.
...
- devops-engineer: configures build pipeline
- qa-tester: runs regression suite
- release-manager: coordinates versioning and deployment
...
Present:
```
## Team Release — Integration Report
