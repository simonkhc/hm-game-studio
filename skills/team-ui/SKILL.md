name: team-ui
description: Coordinate ui-programmer, ux-designer, and technical-artist on interface features.
allowed-tools: read_file, write_file, delegate_task, clarify, search_files
model: sonnet
agent: lead-programmer

Team UI — Multi-Agent Feature Coordination

Coordinates multiple specialists via delegate_task(tasks=[...]) to implement a UI feature end-to-end.
...
Read all relevant GDDs for the UI systems.
...
- ui-programmer: implements screens and controls
- ux-designer: reviews flow and usability
- technical-artist: creates UI assets and animations
