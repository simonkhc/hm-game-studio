name: team-live-ops
description: Coordinate live-ops-designer, analytics-engineer, and community-manager on live operations.
allowed-tools: read_file, write_file, delegate_task, clarify, search_files
model: sonnet
agent: producer

Team Live Ops — Multi-Agent Feature Coordination

Coordinates multiple specialists via delegate_task(tasks=[...]) to implement a live operations feature end-to-end.
...
Read all relevant GDDs for the live operations systems.
...
- live-ops-designer: designs event/season structure
- analytics-engineer: implements telemetry
- community-manager: drafts player communications
...
Present:
```
## Team Live Ops — Integration Report
