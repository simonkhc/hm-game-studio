name: team-combat
description: Coordinate gameplay-programmer, technical-artist, and sound-designer on a combat feature.
allowed-tools: read_file, write_file, delegate_task, clarify, search_files
model: sonnet
agent: lead-programmer

Team Combat — Multi-Agent Feature Coordination

Coordinates multiple specialists via delegate_task(tasks=[...]) to implement a combat feature end-to-end.
...
Read all relevant GDDs for the combat systems.
...
- gameplay-programmer: implements combat mechanics, damage system, hit detection
- technical-artist: creates VFX (hit sparks, trails, impacts)
- sound-designer: creates SFX (hit sounds, weapon sounds)
...
Present:
```
## Team Combat — Integration Report
